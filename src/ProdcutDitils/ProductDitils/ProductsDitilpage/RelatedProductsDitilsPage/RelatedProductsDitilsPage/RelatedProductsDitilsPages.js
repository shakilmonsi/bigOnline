...
import "./RelatedProductsDitilsPages.css"
import RelatedProductsDitilsPageCard from '../RelatedProductsDitilsPageCard/RelatedProductsDitilsPageCard';
...
const RelatedProductsDitilsPages = () => {
...
<div className='grid_followedProduct_item ms-4'>
            ...
            {
                servicesData.map(service => <RelatedProductsDitilsPageCard
                    key={service.id}
                    service={service}
                ></RelatedProductsDitilsPageCard>)
            }
...
export default RelatedProductsDitilsPages;