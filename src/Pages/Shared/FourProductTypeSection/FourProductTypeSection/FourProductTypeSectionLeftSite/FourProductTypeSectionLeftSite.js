...
import FourProductTypeSectionLeftSitePrducts from '../FourProductTypeSectionLeftSiteProducts/FourProductTypeSectionLeftSiteProducts/FourProductTypeSectionLeftSitePrducts';
const FourProductTypeSectionLeftSite = () => {
    return (
        <section>
            <div>
                 {/* main dib up  */}
...
export default FourProductTypeSectionLeftSite;