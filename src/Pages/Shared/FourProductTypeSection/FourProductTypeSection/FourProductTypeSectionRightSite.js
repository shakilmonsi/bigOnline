...
import "./FourProductTypeSection.css";
     ...
     <div className="row">
      <div className=" ">
          ...
          <div>
            <div className="d-flex gap-4">
              <div className="align-items-center d-flex gap-2">
                <Form.Check
                  type="radio"
                  style={{ width: "14px", height: "14px", color: "#717171" }}
                  aria-label="radio 1"
                />
              ...
              <div className="align-items-center d-flex gap-2">
                <Form.Check
                  ...
                  aria-label="radio 1"
                />
                <span className="physial_digital_style mt-">
                  Digital Products
                </span>
              </div>
            </div>
            ...
            <div style={{ marginTop: "68px" }}>
              ...
              <div
                className="d-flex "
                style={{ alignItems: "center", gap: "40px", marginTop: "20px" }}
              >
                <div>
                ...
                <div>
                  <span className="ms-4" style={{ marginTop: -44 }}>
                    Max Price
                  </span>
       ...
       "
          ...
          <div
            className=""
            style={{ marginTop: "20px", padding: " 20px 0px 0px 2px" }}
          >
            <div className="d-flex justify-content-between ">
              <h6>Delivery type</h6>
              <p>Clear</p>
       ...
       "
          ...
          <div
            className="get_more_done_section_style"
            style={{ margin: "50px" }}
          >
            <div
              className="p-4"
            ...
            >
              <h4 className="get_more_text" style={{ marginTop: 33 }}>
                Get More Done Together With US
              </h4>
              <p className="get_more_paragrap_setyle mt-3">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
              <button className="button_style_get-stard mt-3" style={{ marginLeft: 59 }}>
                <span className="button_text_style">Get Started</span>
              </button>
            </div>
          </div>
...
export default FourProductTypeSectionRightSite;
