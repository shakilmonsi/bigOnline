...
const RecommendedForYous = () => {
    ...
    return (
        <section className='py-3' style={{ backgroundColor: "#FFFFFF",marginTop:"47px" , paddingLeft:"85px", paddingRight:"79px" }}>
             <div className='d-flex justify-content-between px-4 ' style={{padding:"20px"}}>
                                <h4 style={{color:"#000", paddingLeft:"1px", fontSize:"22px",fontFamily:"inter",fontWeight:500,lineHeight:"normal"}}>Recommended For You</h4>
                                <Link to="/" className='' style={{ paddingRight:"20px", color:"#000",fontFamily:"inter",fontSize:"18px",fontWeight:500,fontStyle:"normal",lineHeight:"normal"}}>View All</Link>

                        </div>

                        <div className=' mt-3'>

<div className='grid_RecommendedForYous_item'>
