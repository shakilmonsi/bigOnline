...
import "./RightSiteProductDispalyCard.css"
import shopingcardicon from "../../../../../../../../../../assets/shopingcardiconbutton/shopingicon.svg";


const RightSiteProductDispalyalCard = ({ rgihtsiteproductdata }) => {
        const { name, verifide,thredot,offers, description, img, price, delprice 
                 ,hardicon,redingicon,widthredingicon ,grayverifyde} = rgihtsiteproductdata;
...
export default RightSiteProductDispalyalCard;